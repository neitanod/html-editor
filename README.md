...
have no business being published — hard enough to be a decision rather than a
suggestion. The discs number themselves in the order you drop them, so the
paragraph underneath can say "the error is in the 2".
