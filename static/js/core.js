...
(function (global) {
  ...
  var STRINGS = {
    en: {
      ...
      'toolbar.print': 'Print: paper, margins, scale and PDF',
      'toolbar.printShort': 'Print',
      // -- printing -----------------------------------------------------------
      'print.title': 'Print',
      'print.sec.paper': 'Paper',
      'print.paper': 'Size',
      'print.paperCustom': 'Custom size…',
      'print.customSize': 'Width × height (mm)',
      'print.orientation': 'Orientation',
      'print.portrait': 'Portrait',
      'print.landscape': 'Landscape',
      'print.lockPaper': 'Pin this paper on the print job',
      'print.lockHint': 'Pinned, the browser dialog shows this paper and greys the choice out. ' +
        'Unpinned, it only gets the margins and you pick paper and orientation there.',
      'print.sec.margins': 'Margins',
      'print.marginPreset': 'Preset',
      'print.marginNormal': 'Normal (20 mm)',
      'print.marginNarrow': 'Narrow (10 mm)',
      'print.marginWide': 'Wide (25 / 30 mm)',
      'print.marginNone': 'None',
      'print.marginCustom': 'Custom…',
      'print.top': 'Top', 'print.right': 'Right', 'print.bottom': 'Bottom', 'print.left': 'Left',
      'print.sec.scale': 'Scale',
      'print.scale': 'Scale (%)',
      'print.fitWidth': 'Shrink until the page is wide enough',
      'print.sec.content': 'What goes on the paper',
      'print.dropPage': 'Ignore the document’s own page setup (@page)',
      'print.backgrounds': 'Print background colours and images',
      'print.keepTogether': 'Keep tables, pictures and figures whole',
      'print.repeatHeaders': 'Repeat table headers on every page',
      'print.fitImages': 'Shrink pictures wider than the page',
      'print.fullWidth': 'Use the whole width (drop the page max-width)',
      'print.dropPageHint': 'A document carrying its own @page is why the browser dialog greys out ' +
        'paper and orientation. Ignoring it is what gives those options back.',
      'print.sec.tools': 'Page breaks',
      'print.insertBreak': 'Insert a page break at the cursor',
      'print.breakInserted': 'Page break inserted',
      'print.breakNoCursor': 'Put the cursor where the new page should start first',
      'print.preview': 'Preview',
      'print.pages': 'About {n} page(s) · {w} × {h} mm',
      'print.print': 'Print…',
      'print.saveInDocument': 'Save in the document',
      'print.saveInDocumentHint': 'Writes this page setup into the file, so it also prints this way ' +
        'outside the editor',
      'print.saved': 'Page setup written into the document',
      'print.failed': 'The document could not be prepared for printing',
      'print.notReady': 'The document is still loading',
      'print.cssComment': 'Page setup written by html-editor. Edit it freely: the editor only ' +
        'rewrites this tag when you press “Save in the document” again.',
      'menu.pageBreak': 'Page break here',
      ...
      'image.vector': 'An SVG is drawn from shapes: editing it here would turn it into a bitmap',
      'image.remoteTitle': 'The image is on another site',
      'image.remoteBody': 'It has to be stored next to the document before it can be edited.',
      'image.remoteHint': 'The file lands in this folder and the document links it relatively, which is the same thing the paste dialog offers.',
      ...
      'mark.undo': 'Undo (Ctrl+Z)', 'mark.redo': 'Redo (Ctrl+Y)',
      'mark.clear': 'Take every mark off', 'mark.clearLabel': 'Clear',
      'mark.remove': 'Delete this mark (Del)',
      'mark.stroke': 'Outline', 'mark.fill': 'Fill', 'mark.width': 'Thickness',
      'mark.color': 'Colour', 'mark.size': 'Size',
      'mark.shadow': 'Shadow', 'mark.rounded': 'Rounded',
      'mark.strength': 'Blur', 'mark.light': 'light', 'mark.strong': 'strong',
    ...
    es: {
      ...
      'toolbar.print': 'Imprimir: papel, márgenes, escala y PDF',
      'toolbar.printShort': 'Imprimir',
      // -- impresión ----------------------------------------------------------
      'print.title': 'Imprimir',
      'print.sec.paper': 'Papel',
      'print.paper': 'Tamaño',
      'print.paperCustom': 'Medidas a mano…',
      'print.customSize': 'Ancho × alto (mm)',
      'print.orientation': 'Orientación',
      'print.portrait': 'Vertical',
      'print.landscape': 'Horizontal',
      'print.lockPaper': 'Fijar este papel en el trabajo de impresión',
      'print.lockHint': 'Fijado, el diálogo del navegador muestra este papel y deja la opción en gris. ' +
        'Suelto, recibe solamente los márgenes y el papel y la orientación los elegís ahí.',
      'print.sec.margins': 'Márgenes',
      'print.marginPreset': 'Preajuste',
      'print.marginNormal': 'Normales (20 mm)',
      'print.marginNarrow': 'Angostos (10 mm)',
      'print.marginWide': 'Anchos (25 / 30 mm)',
      'print.marginNone': 'Sin márgenes',
      'print.marginCustom': 'A medida…',
      'print.top': 'Arriba', 'print.right': 'Derecha', 'print.bottom': 'Abajo', 'print.left': 'Izquierda',
      'print.sec.scale': 'Escala',
      'print.scale': 'Escala (%)',
      'print.fitWidth': 'Achicar hasta que entre en el ancho de la hoja',
      'print.sec.content': 'Qué va en el papel',
      'print.dropPage': 'Ignorar los ajustes de página del documento (@page)',
      'print.backgrounds': 'Imprimir colores e imágenes de fondo',
      'print.keepTogether': 'Mantener enteras las tablas, las imágenes y las figuras',
      'print.repeatHeaders': 'Repetir el encabezado de las tablas en cada hoja',
      'print.fitImages': 'Achicar las imágenes más anchas que la hoja',
      'print.fullWidth': 'Usar todo el ancho (sacar el max-width de la página)',
      'print.dropPageHint': 'Un documento que trae su propio @page es la razón por la que el diálogo ' +
        'del navegador deja en gris el papel y la orientación. Ignorarlo devuelve esas opciones.',
      'print.sec.tools': 'Saltos de página',
      'print.insertBreak': 'Insertar un salto de página en el cursor',
      'print.breakInserted': 'Salto de página insertado',
      'print.breakNoCursor': 'Poné el cursor donde tiene que empezar la hoja nueva',
      'print.preview': 'Previsualización',
      'print.pages': 'Alrededor de {n} hoja(s) · {w} × {h} mm',
      'print.print': 'Imprimir…',
      'print.saveInDocument': 'Guardar en el documento',
      'print.saveInDocumentHint': 'Escribe estos ajustes de página en el archivo, así también ' +
        'imprime así fuera del editor',
      'print.saved': 'Ajustes de página escritos en el documento',
      'print.failed': 'El documento no se pudo preparar para imprimir',
      'print.notReady': 'El documento todavía se está cargando',
      'print.cssComment': 'Ajustes de página que escribió html-editor. Editalos a gusto: el editor ' +
        'vuelve a pisar esta etiqueta solamente cuando apretás «Guardar en el documento».',
      'menu.pageBreak': 'Cortar la hoja acá',
      ...
      'image.vector': 'Un SVG está dibujado con formas: editarlo acá lo convertiría en un mapa de bits',
      'image.remoteTitle': 'La imagen está en otro sitio',
      'image.remoteBody': 'Hay que guardarla junto al documento antes de poder editarla.',
      'image.remoteHint': 'El archivo queda en esta carpeta y el documento lo enlaza de forma relativa, que es lo mismo que ofrece el diálogo de pegado.',
      ...
      'mark.undo': 'Deshacer (Ctrl+Z)', 'mark.redo': 'Rehacer (Ctrl+Y)',
      'mark.clear': 'Sacar todas las marcas', 'mark.clearLabel': 'Limpiar',
      'mark.remove': 'Borrar esta marca (Supr)',
      'mark.stroke': 'Borde', 'mark.fill': 'Fondo', 'mark.width': 'Grosor',
      'mark.color': 'Color', 'mark.size': 'Tamaño',
      'mark.shadow': 'Sombra', 'mark.rounded': 'Redondeado',
      'mark.strength': 'Difuminado', 'mark.light': 'suave', 'mark.strong': 'fuerte',
      'mark.total': 'ilegible',
