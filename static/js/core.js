...
(function (global) {
  ...
  var STRINGS = {
    en: {
      ...
      'mark.tool.blur': 'Blur a patch', 'mark.tool.rect': 'Box',
      'mark.tool.ellipse': 'Ellipse', 'mark.tool.line': 'Line', 'mark.tool.arrow': 'Arrow',
      'mark.undo': 'Undo the last mark (Ctrl+Z)', 'mark.redo': 'Put it back (Ctrl+Y)',
      ...
      'mark.marks': 'marks', 'mark.none': 'no marks yet',
      'mark.hint': 'Drag over the picture to draw. The original file is kept: the marked copy is written next to it.',
    ...
    es: {
      ...
      'mark.tool.blur': 'Difuminar una zona', 'mark.tool.rect': 'Recuadro',
      'mark.tool.ellipse': 'Elipse', 'mark.tool.line': 'Línea', 'mark.tool.arrow': 'Flecha',
      'mark.undo': 'Deshacer la última marca (Ctrl+Z)', 'mark.redo': 'Devolverla (Ctrl+Y)',
      ...
      'mark.total': 'ilegible',
      'mark.marks': 'marcas', 'mark.none': 'todavía sin marcas',
      'mark.hint': 'Arrastrá sobre la imagen para dibujar. El archivo original se conserva: la copia marcada se escribe al lado.',
      // -- la imagen en grande -------------------------------------------------
